...
import { TerminalIcon, User, Briefcase, Code, Mail } from "lucide-react"
        ...
        output: (
          <div className="space-y-2">
            ...
            <p className="font-mono text-white">
              Welcome to Adarsh Singh's developer portfolio! Type help to see available commands.
            </p>
          </div>
        ),
        timestamp: new Date(),
        ...
        output = (
          <div className="space-y-2 text-white">
            ...
            <ul className="space-y-1">
              <li>
                <span className="text-white font-bold">about</span> - Learn about Adarsh
              </li>
              <li>
    ...
    <div className="flex flex-col h-full">
      <div className="bg-black border border-white/30 rounded-t-md p-2 flex items-center">
        ...
        <span className="text-sm font-mono text-white">
          adarsh@developer ~ {currentSection ? `/${currentSection}` : ""}
        </span>
      </div>
